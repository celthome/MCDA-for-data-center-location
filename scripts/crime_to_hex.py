...
natural_hazards = gpd.read_file('../data/output/crime_reclass.geojson')
centroids_classified = gpd.read_file('../data/output/centroids_classified.geojson')

# Extract the value of the "Germany" row
germany_value = natural_hazards.loc[natural_hazards['Country'] == 'Germany', 'reclassified'].values[0]
...
centroids_classified.to_file('../data/output/centroids_classified_disaster_crime.geojson', driver='GeoJSON')